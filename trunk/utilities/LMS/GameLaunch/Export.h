 ...
 */
#ifndef DELTA_GAME_LAUNCH_EXPORT_H
#define DELTA_GAME_LAUNCH_EXPORT_H
 ...
 * trying to import Delta3D symbols.  The GAME_LAUNCH_EXPORT macro should be used
 * in front of any classes that are to be exported.
 * Also note that GAME_LAUNCH_LIBRARY should be defined in the compiler 
 * preprocessor #defines.
 */
#if defined(_MSC_VER) || defined(__CYGWIN__) || defined(__MINGW32__) || defined( __BCPLUSPLUS__)  || defined( __MWERKS__)
#  ifdef GAME_LAUNCH_LIBRARY
#    define GAME_LAUNCH_EXPORT __declspec(dllexport)
#  else

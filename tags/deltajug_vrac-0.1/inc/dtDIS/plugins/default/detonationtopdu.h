#ifndef __DELTA_PLUGIN_DETONATION_TO_PDU_H__
#define __DELTA_PLUGIN_DETONATION_TO_PDU_H__
...
namespace dtDIS
{
    ...
    class DT_DIS_DEFAULT_EXPORT DetonationToPdu : public dtDIS::IMessageToPacketAdapter
    {
        public:
            DetonationToPdu(dtDIS::SharedState* config, dtGame::GameManager* gm);
            ~DetonationToPdu();
        ...
        private:
            ...
            DetonationToPdu(); //< not implemented by design

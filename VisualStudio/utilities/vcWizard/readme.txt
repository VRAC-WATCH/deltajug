...
1. Copy the contents of:
   ...
   to the VSWizards folder (e.g., C:\Program Files\Microsoft Visual Studio 9.0\VC\VCWizards)

2. Copy the contents of:
      delta3d\VisualStudio\utilities\vcWizard\vcprojects
   to the vsprojects folder (e.g., C:\Program Files\Microsoft Visual Studio 9.0\VC\vcprojects)
